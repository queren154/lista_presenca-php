        ...
        <div class="col-12">
            ...
            <div class="mb-3" hidden>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="evento" value="<?= $dados['evento'] ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Facilitador</label>
                    <input type="text" class="form-control" name="facilitador" value="<?= $dados['facilitador'] ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Local</label>
                    <input type="text" class="form-control" name="local_evento" value="<?= $dados['local_evento'] ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Data</label>
                    <input type="date" class="form-control" name="data_evento" value="<?= $dados['data_evento'] ?>">
                </div>
